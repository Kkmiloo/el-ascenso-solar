...
export const Dialog = ({
  ...
  return (
    <div
      ...
      }  py-6  px-6 md:py-10 text-gray-800 text-xl text-justify font-medium rounded-xl border-4 bg-gray-100  md:h-[220px] w-full h-auto max-w-6xl min-h-44 md:min-h-52 m-auto z-20`}
      onClick={handleNext}
    >
